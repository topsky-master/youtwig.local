...
<?php elseif($arResult['CAN_BUY']): ?>
    ...
    <?php if(isset($arParams['ONE_CLICK_ORDER'])
        ...
        <button onClick="yaCounter21503785.reachGoal('oneclick');" class="btn btn-default btn-oneclick btn-preorder-<?=$arResult['PRODUCT_ID'];?>"<?php if($arResult['IS_PREODERED']): ?> disabled="disabled"<?php endif; ?> data-toggle="modal" data-target="#modalOCBuy" data-product-id="<?=$arResult['PRODUCT_ID'];?>">
...
<?php else: ?>
    <?php if(isset($arParams['ONE_CLICK_PREORDER'])
        ...
        && $arResult['HAS_PRICE']): ?>
        <button onClick="yaCounter21503785.reachGoal('preorder');" class="btn btn-default btn-preorder btn-preorder-<?=$arResult['PRODUCT_ID'];?>"<?php if($arResult['IS_PREODERED']): ?> disabled="disabled"<?php endif; ?> data-toggle="modal" data-target="#modalOCBuy" data-product-id="<?=$arResult['PRODUCT_ID'];?>">
