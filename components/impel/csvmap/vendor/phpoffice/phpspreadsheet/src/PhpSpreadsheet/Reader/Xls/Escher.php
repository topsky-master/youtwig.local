...
class Escher
{
    ...
    private function readBSE()
    {
        ...
        $btWin32 = mb_ord($recordData[0]);

        // offset: 1; size: 1; btWin32 (MSOBLIPTYPE)
        $btMacOS = mb_ord($recordData[1]);
        ...
        $unused1 = mb_ord($recordData[32]);

        // offset: 33; size: 1; size of nameData in bytes (including null terminator)
        $cbName = mb_ord($recordData[33]);

        // offset: 34; size: 1; unused2
        $unused2 = mb_ord($recordData[34]);

        // offset: 35; size: 1; unused3
        $unused3 = mb_ord($recordData[35]);
