...
class Calculation
{
    ...
    private static function loadLocales()
    {
        ...
        foreach (glob($localeFileDirectory . '*', GLOB_ONLYDIR) as $filename) {
            $filename = mb_substr($filename, mb_strlen($localeFileDirectory));
            if ($filename != 'en') {
        ...
        if (in_array($language, self::$validLocaleLanguages)) {
            ...
            if ($locale != 'en_us') {
                ...
                foreach ($localeFunctions as $localeFunction) {
                    ...
                    if (mb_strpos($localeFunction, '=') !== false) {
        ...
        while (true) {
            ...
            if ($opCharacter == '-' && !$expectingOperator) {                //    Is it a negation instead of a minus?
                ...
                if (preg_match('/^' . self::CALCULATION_REGEXP_FUNCTION . '$/i', $val, $matches)) {
                    ...
                    if (isset(self::$phpSpreadsheetFunctions[mb_strtoupper($matches[1])]) || isset(self::$controlFunctions[mb_strtoupper($matches[1])])) {    // it's a function
                        $valToUpper = mb_strtoupper($val);
                    ...
                    if ($opCharacter == '"') {
                        ...
                        if ((mb_strpos($val, '.') !== false) || (mb_stripos($val, 'e') !== false) || ($val > PHP_INT_MAX) || ($val < -PHP_INT_MAX)) {
                            $val = (float) $val;
                        } else {
                            $val = (int) $val;
                        }
        ...
        foreach ($tokens as $tokenData) {
            ...
            if (isset(self::$binaryOperators[$token])) {
                ...
                switch ($token) {
                    ...
                    //    Binary Operators
                    case ':':            //    Range
                        if (mb_strpos($operand1Data['reference'], '!') !== false) {
                ...
                if (isset($matches[8])) {
                    if ($pCell === null) {
                        ...
                        if ($matches[2] > '') {
                            ...
                            if ((mb_strpos($matches[2], '[') !== false) || (mb_strpos($matches[2], ']') !== false)) {
