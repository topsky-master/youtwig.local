...
class TextData
{
    ...
    public static function TRIMNONPRINTABLE($stringValue = '')
    {
        ...
        if (self::$invalidChars === null) {
            self::$invalidChars = range(mb_chr(0), mb_chr(31));
        }
    ...
    public static function NUMBERVALUE($value = '', $decimalSeparator = null, $groupSeparator = null)
    {
        ...
        if (!is_numeric($value)) {
            ...
            if (mb_strpos($value, $groupSeparator, $decimalOffset) !== false) {
                return Functions::VALUE();
            }
            ...
            $percentageAdjustment = mb_strlen($value) - mb_strlen($percentageString);
