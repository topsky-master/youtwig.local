...
class Date
{
    ...
    {
        if (mb_strtolower($pFormatCode) === mb_strtolower(NumberFormat::FORMAT_GENERAL)) {
        ...
        if ((mb_substr($pFormatCode, 0, 1) == '_') || (mb_substr($pFormatCode, 0, 2) == '0 ')) {
            return false;
        }
        ...
        if (preg_match('/(^|\])[^\[]*[' . self::$possibleDateFormatCharacters . ']/i', $pFormatCode)) {
            ...
            if (mb_strpos($pFormatCode, '"') !== false) {
                $segMatcher = false;
