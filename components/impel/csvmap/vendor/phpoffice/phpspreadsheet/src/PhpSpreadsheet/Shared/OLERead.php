...
class OLERead
{
    ...
    private function readPropertySets()
    {
        ...
        while ($offset < $entryLen) {
            ...
            $nameSize = mb_ord($d[self::SIZE_OF_NAME_POS]) | (mb_ord($d[self::SIZE_OF_NAME_POS + 1]) << 8);

            // type of entry
            $type = mb_ord($d[self::TYPE_POS]);
            ...
            // Summary information
            if ($name == mb_chr(5) . 'SummaryInformation') {
                $this->summaryInformation = count($this->props) - 1;
            }

            // Additional Document Summary information
            if ($name == mb_chr(5) . 'DocumentSummaryInformation') {
