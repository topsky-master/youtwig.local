...
class StringHelper
{
    ...
    public static function getIsIconvEnabled()
    {
        ...
        if (!function_exists('iconv')) {
            ...
            self::$isIconvEnabled = false;
        } elseif (defined('PHP_OS') && @mb_stristr(PHP_OS, 'AIX') && defined('ICONV_IMPL') && (@strcasecmp(ICONV_IMPL, 'unknown') == 0) && defined('ICONV_VERSION') && (@strcasecmp(ICONV_VERSION, 'unknown') == 0)) {
     ...
     * @return string
     */
    public static function mb_strtoupper($pValue)
    {
     ...
     * @return string
     */
    public static function mb_strtolower($pValue)
    {
