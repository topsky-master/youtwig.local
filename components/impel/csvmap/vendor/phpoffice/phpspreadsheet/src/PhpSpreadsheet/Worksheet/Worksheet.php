...
class Worksheet implements IComparable
{
    ...
    public function getCell($pCoordinate, $createIfNotExists = true)
    {
        ...
        $pCoordinateUpper = mb_strtoupper($pCoordinate);
        ...
        // Worksheet reference?
        if (mb_strpos($pCoordinate, '!') !== false) {
        ...
        } elseif (mb_strpos($pCoordinate, '$') !== false) {
    ...
    {
        return isset($this->conditionalStylesCollection[mb_strtoupper($pCoordinate)]);
    }
    ...
    public function getComment($pCellCoordinate)
    {
        ...
        } elseif (mb_strpos($pCellCoordinate, '$') !== false) {
    ...
    public static function extractSheetTitle($pRange, $returnRange = false)
    {
        ...
        if (($sep = mb_strrpos($pRange, '!')) === false) {
            return $returnRange ? ['', $pRange] : '';
        }

        if ($returnRange) {
            return [mb_substr($pRange, 0, $sep), mb_substr($pRange, $sep + 1)];
        }
