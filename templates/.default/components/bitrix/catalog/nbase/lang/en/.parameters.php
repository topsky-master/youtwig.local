...
$MESS["CPT_LIST_TYPE"] = "Products list at section: list or grid";
$MESS["CPT_BC_TPL_VIEW_LIST"] = "List";
$MESS["CPT_BC_TPL_VIEW_GRID"] = "Grid";
$MESS["CPT_BC_ELEMENTS_COLLAPSE"] = "How many labels show without button More?";
$MESS["CPT_LIST_DISPLAY_CODES_VERTICAL"] = "List of properties codes for vertical filter list (separated by ,)";
$MESS["CPT_LIST_DISPLAY_CODES_HORIZONTAL"] = "List of properties codes for horizontal filter list (separated by ,)";
$MESS["CPT_NOT_MUCH"] = "How many amount of product will be with status Not much?";
$MESS["CPT_SET_SECTION_ID"] = "ID of section to create filter by root of catalog directory";
