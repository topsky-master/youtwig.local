    ...
    function rb($, Q) {
        function aa() {
            ...
            q.children().each(function (e, c) {
                var f = {}, g = a.settings.shuffle ? parseInt(i(c).data("index")) : e;
                f.properties = {};
                x.push(i(this));
        ...
        function Ya() {
            ...
            q.find(".layer.static").each(function () {
                ...
                else c.css(d, 0); if (typeof f.vertical !== "undefined")
            ...
            q.find(".jw-player").length && q.find(".jw-player").each(function (c) {
                ...
                if (sources.length) {
                    ...
                    else jwPlayerArgs.levels = sources; if (video.data("provider")) jwPlayerArgs.provider = video.data("provider");
            ...
            q.find("a.video").length && q.find("a.video").each(function () {
                ...
                c.click(function (h) {
                    ...
                    else a.settings.videoPlayAction == "pauseSlideshow" && !N && oa(); if (a.settings.leaveVideoAction ==
            ...
            if (a.settings.fullscreenControls && !(Ja || R == "msie")) Da();
            ...
            case "proportionalFit":
                if (b.data("index") == o && b.data("loaded")) {
                    ...
                    if (a.settings.thumbnailType == "scroller" || a.settings.thumbnailType == "tooltipAndScroller") {
                        ...
                        Oa();
                        a.settings.thumbnailMouseScroll && Pa()
                    } else s.css("height", O.height()); if (C != -1) {
        ...
        function qa(b) {
            if (b != o) {
                ...
                } else xb(); if (a.settings.slideButtons) {
        ...
        function S() {
            ...
            if (c.length &&
                ...
                else e == "image" && f.addClass("magnifying"); if (a.settings.lightboxIconToggle && !ea) f.css("opacity", 0);
                else w || f.css({
                    opacity: 0
                }).stop().animate({
                    opacity: 1
            ...
            x[o].children(".layer").not(".static, .init").each(function () {
                ...
                else g.css(k, 0); if (typeof d.vertical !== "undefined")
                ...
                R == "msie" && parseInt(ja) <= 7 ? g.css("visibility", "inherit").css(h) : g.addClass("init").delay(d.delay).css(j).css("visibility", "inherit").animate(h, d.duration, d.easing, function () {
                    if (d.horizontal)
                        ...
                        g.css("margin-" + k, -g.outerWidth(false) *
                            0.5);
                        g.css(k, "50%")
                    } else g.css(k, d.horizontal); if (d.vertical)
                        if (d.vertical == "top" && l == "top" || d.vertical == "bottom" && l == "bottom") g.css(l, 0);
                        else if (d.vertical == "bottom" && l == "top" || d.vertical == "top" && l == "bottom") {
                        g.css("margin-" + l, -g.outerHeight(false));
                        g.css(l, "100%")
                    ...
                    c && q.swipe({
                        ...
                        swipeLeft: function () {
                            o < K - 1 ? ra() : q.stop().animate({
                                ...
                                a.settings.swipeEasing, function () {
                                    U && S()
                                });
                            a.settings.swipeGrabCursor && q.removeClass("grabbing").addClass("grab")
                        },
        ...
        function gc(b, e, c, f, g, d, h, j, p) {
            var k = {}, l = {}, n = parseInt(b.css("width")),
        ...
        var Va = {}, Wa = {}, Xb = window.setTimeout,
...
(function (i, rb) {
    var $ = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";
