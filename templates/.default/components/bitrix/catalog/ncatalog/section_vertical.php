...
twigBuildSectionFilter::skipAnalogueFilter($arPreFilter);
	...
	false
        ...
        <div class="stock-price-download">
            <a href="/upload/acrit.exportproplus/stock.xlsx">
                <img src="/upload/icon-stock-download.png" alt="full stock download">
                <p>Прайс-лист нашего магазина</p>
            </a>
        </div>
    </div>
    <div class="col-md-9 product-lis col-lg-9">
        <?

        if($arParams["DISPLAY_CODES_HORIZONTAL"] != ''
            && $arParams["DISPLAY_CODES_HORIZONTAL"] != '-'){
        ...
        <div id="comp_smart_filter">
            ...
            } else if ($intSectionID) {
                twigSeoSections::printSeoAndSetTitlesSection($intSectionID,$arParams);
            }
            ...
            twigSmartFilters::fixTypeOfProduct();
