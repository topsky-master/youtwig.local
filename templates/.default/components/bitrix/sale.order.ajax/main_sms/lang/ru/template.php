...
$MESS['SOA_TEMPL_PREORDER'] = "Предоплата по предзаказу";
$MESS['SOA_TEMPL_PREORDER_TIME'] = "* срок поставки на склад до 5 рабочих дней";

$MESS['SOA_SDEKDELIVERY'] = "Выберите пункт самовывоза";
$MESS['SOA_BOXBERRYDELIVERY'] = "Выберите пункт самовывоза";

$MESS['SOA_YANDEXDELIVERY'] = "Выберите пункт самовывоза";

$MESS['SOA_STATIONDELIVERY'] = "Выберите станцию метро";
$MESS['SOA_DAYOFDELIVERY'] = "Выберите день доставки";
$MESS['SOA_TIMEOFDELIVERY'] = "Выберите время доставки";
...
$MESS['SALE_PRODUCTS_SUMMARY'] = "Оформление заказа";
...
$MESS['SOA_SMS_INFO'] = "я выражаю свое согласие на СМС информирование о статусе заказа";
$MESS['SOA_NAME'] = "Название";
$MESS['SOA_PROPERTIES'] = "Свойства";
$MESS['SOA_COUNT'] = "Кол-во";
$MESS['SOA_PRICE'] = "Цена";

$MESS['SOA_TEMPL_RECOUNT'] = "Пересчитать";
$MESS['SOA_TEMPL_EMPTY_CART'] = "В Вашей корзине нет товаров";
$MESS['SOA_TEMPL_SUM_IT'] = "Итого к оплате:";

$MESS['SOA_TEMPL_ENTER_THE_CITY'] = "Чтобы выбрать службу доставки, заполните поле Город";
$MESS['SOA_TEMPL_CHOOSE_DELIVERY'] = "Выберите службу доставки";

$MESS['SOA_INVALID_PHONE'] = "Не верный формат телефона. Для России формат ввода - +7 926 12 111 11, или выберите другую страну";
...
$MESS['SOA_TEMPL_ARTICUL'] = 'Код товара ';
$MESS['SOA_TEMPL_PROMO'] = 'Промо-код';

$MESS['SOA_TEMPL_PROMO_ACTIVE'] = "Купон активирован";
$MESS['SOA_TEMPL_PROMO_ERROR'] = "Ошибка активации купона";
$MESS['SOA_TEMPL_PROMO_NOT_FOUND'] = "Купон не найден";
$MESS['SOA_TEMPL_PROMO_ALREADY_APPLIED'] = "Купон уже активирован";
$MESS['SOA_TEMPL_CITY'] = 'Населенный пункт';
$MESS['SOA_TEMPL_STREET'] = 'Улица';
$MESS['SOA_CALCULATE_ERRORS'] = 'Ошибка расчета. Проверьте город, выберите другую службу доставки.';


$MESS['TMPL_CHECK_PHONE'] = "Пожалуйста, проверьте телефон";
$MESS['TMPL_CHECK_PHONE_DESCR'] = "Пожалуйста, проверьте телефон";
$MESS['TMPL_CHECK_PHONE_BTN'] = "Все верно";
