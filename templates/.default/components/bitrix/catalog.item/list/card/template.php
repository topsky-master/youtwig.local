...
?>
<div class="item-images col-sm-4">
    <?php if ($item['MORE_PHOTO_COUNT'] > 0) {
        ...
        <?php foreach ($item['MORE_PHOTO'] as $key => $photo) { ?>
            <div class="swiper-slide<?php if ($key == 0): ?> swiper-slide-active<?php endif; ?>">
                <div class="slider__image">
                    <a class="piiw" href="<?= $item['DETAIL_PAGE_URL'] ?>"><img itemprop="image"
                                                                                src="<?= $photo['SRC'] ?>"
                                                                                alt="<?= htmlspecialchars($productTitle, ENT_QUOTES, LANG_CHARSET); ?>"
    ...
    ; ?>
        ...
        <a class="piiw" href="<?= $item['DETAIL_PAGE_URL'] ?>">
            <img src="<?= $item['PREVIEW_PICTURE']['SRC'] ?>" class="img-responsive"
                 alt="<?= htmlspecialchars($productTitle, ENT_QUOTES, LANG_CHARSET); ?>"/>
        </a>
        <?php
    }
