...
$arTemplateParameters['DISPLAY_CODES'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('TP_BCSF_DISPLAY_CODES'),
	'TYPE' => 'TEXT',
	'DEFAULT' => '',
);

$arTemplateParameters['DISPLAY_AS_SELECTS'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('TP_BCSF_DISPLAY_AS_SELECTS'),
	'TYPE' => 'TEXT',
	'DEFAULT' => '',
);

$arTemplateParameters['FORM_CATALOG'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('TP_BCSF_FORM_CATALOG'),
	'TYPE' => 'TEXT',
	'DEFAULT' => '',
);

$arTemplateParameters['FILTER_BUTTON_NAME'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('TP_BCSF_FILTER_BUTTON_NAME'),
	'TYPE' => 'TEXT',
	'DEFAULT' => '',
);

$arTemplateParameters['ELEMENTS_COLLAPSE'] = array(
	'NAME' => GetMessage('TP_BCSF_ELEMENTS_COLLAPSE'),
	'TYPE' => 'TEXT',
	'DEFAULT' => '9',
);
