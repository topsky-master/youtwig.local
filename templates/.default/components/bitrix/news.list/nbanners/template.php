...
if(isset($arResult["ITEMS"])
  ...
  <span class="word1">Популярные</span> <span class="word2">производители</span>
  </div>
    <div class="banner-static-contain">
        <?foreach($arResult["ITEMS"] as $cell=>$arElement):?>
            <?if(is_array($arElement["PREVIEW_PICTURE"]) || is_array($arElement["DETAIL_PICTURE"])):?>
                <div class="banner-box">
                    <a href="<?php if(isset($arElement["PROPERTIES"]["URL_BANNER"]["VALUE"])): ?><?php echo $arElement["PROPERTIES"]["URL_BANNER"]["VALUE"]; ?><?php else : ?><?=$arElement["DETAIL_PAGE_URL"]?><?php endif; ?>">
