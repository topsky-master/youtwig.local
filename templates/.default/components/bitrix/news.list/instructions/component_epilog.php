...
if(isset($arResult["NAV_STRING"]) && !empty($arResult["NAV_STRING"])){
    ...
    if($arResult["NavPageNomer"] > 1){
        ...
        $pagenav_title = \COption::GetOptionString('my.stat', 'pagenav_instructions_title', '', SITE_ID);
        ...
        $pagenav_description = \COption::GetOptionString('my.stat', 'pagenav_instructions_description', '', SITE_ID);
