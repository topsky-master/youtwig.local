...
if(isset($item["DISPLAY_PROPERTIES"])
    ...
    && is_array($item["DISPLAY_PROPERTIES"]["MANUFACTURER_DETAIL"]["VALUE"])
) {
...
$item['TABS']['tab_panels']['DETAIL_TEXT'] = $item['text_for_models'];
...
$cSlidesCount = 4;
$item['NAME'] = $item['models_h1'] ?? $item['default_title'];
?>
