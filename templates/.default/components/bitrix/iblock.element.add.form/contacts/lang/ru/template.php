...
$MESS["IBLOCK_FORM_PLEASE_FILL"] = "Пожалуйста, заполните представленную форму и в ближайшее время наш менеджер свяжется с Вами. ";
$MESS["IBLOCK_FORM_PAY_TOTAL"] = "Сумма заказа: ";
$MESS["IBLOCK_FORM_PAY_RUB"] = " руб.";
$MESS["IBLOCK_FORM_EMPTY_CART"] = "Ваша корзина пуста. Выберите нужный товар.";
$MESS["IBLOCK_NEXT_TEXT"] = "След.";
$MESS["IBLOCK_PREV_TEXT"] = "Пред.";
