...
$arTemplateParameters['IS_MODEL_LIST'] = array(
    'PARENT' => 'VISUAL',
	'NAME' => GetMessage('CP_BCT_TPL_IS_MODEL_LIST'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'Y'
);

$arTemplateParameters['IS_RELATED_TO'] = array(
    'PARENT' => 'VISUAL',
	'NAME' => GetMessage('CP_BCT_TPL_IS_RELATED_TO'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'N'
);
