...
if (!empty($arResult['ITEMS']))
{
    ...
    ?>
    <div class="bx_catalog_list_top pos-top-products top-products-section catalog clearfix <? echo $templateData['TEMPLATE_CLASS']; ?>">
        <div class="row">
        <?
        ...
        foreach ($arResult['ITEMS'] as $key => $arItem){
            ...
            <?php endif; ?>
            <div class="col-xs-6 col-sm-<?=$elementClass;?> col-md-<?=$elementClass;?> col-lg-<?=$elementClass;?>">
                <?
                    ...
                    <div class="bx_catalog_item_container" id="<? echo $strMainID; ?>">
                        <div class="bx_catalog_item_images">
                            ...
                            <ul class="add-to-links add-to-links<? echo $strMainID; ?>">
                                ...
                                <li class="addtoCartElt addtoCartElt<? echo $strMainID; ?> addtoCartElt<?=$arItem['ID'];?><? if (!$arItem['CAN_BUY']){ ?> hidden<? } ?>">
