...
$MESS["CPT_LIST_TYPE"] = "Вид товаров в разделе: список или сетка";
$MESS["CPT_BC_TPL_VIEW_LIST"] = "Список";
$MESS["CPT_BC_TPL_VIEW_GRID"] = "Сетка";
$MESS["CPT_BC_ELEMENTS_COLLAPSE"] = "Сколько элементов показать без кнопки Ещё?";
$MESS["CPT_LIST_DISPLAY_CODES_VERTICAL"] = "Список кодов свойств для вертикального фильтра (через ,)";
$MESS["CPT_LIST_DISPLAY_CODES_HORIZONTAL"] = "Список кодов свойств для горизонтального фильтра (через ,)";
$MESS["CPT_NOT_MUCH"] = "Для скольки единиц товара на складе выставлять статус Наличие: Мало?";
$MESS["CPT_SET_SECTION_ID"] = "ID раздела для фильтров по умолчанию в корне каталога";
