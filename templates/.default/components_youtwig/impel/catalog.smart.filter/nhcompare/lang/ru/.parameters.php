...
$MESS["TP_BCSF_DISPLAY_CODES"] = "Показывать только свойства";
$MESS["TP_BCSF_HIDE_ELEMENT_COUNT"] = "Свернуть элементов";
$MESS["TP_BCSF_HIDE_CURRENTLY_SELECTED"] = "Скрыть выбранные элементы";
