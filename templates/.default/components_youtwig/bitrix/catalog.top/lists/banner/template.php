...
if (!empty($arResult['ITEMS']))
{
    ...
    ?>
    <div class="bx_catalog_list_top pos-top-products top-products-model catalog clearfix <? echo $templateData['TEMPLATE_CLASS']; ?>">
        <div class="row">
            <?
            ...
            foreach ($arResult['ITEMS'] as $key => $arItem){
                ...
                if(isset($arParams['IS_MODEL_LIST'])
                    && $arParams['IS_MODEL_LIST'] == 'Y'){
                    ...
                    if(isset($arParams['MODEL_NAME'])
                        ...
                        $arItem['NAME'] = trim($arParams['MODEL_NAME'][$key]);

                    } else {



                        $typeproduct = isset($arItem['PROPERTIES'])
                        && isset($arItem['PROPERTIES']['TYPEPRODUCT'])
                        && isset($arItem['PROPERTIES']['TYPEPRODUCT']['VALUE'])
                        && !empty($arItem['PROPERTIES']['TYPEPRODUCT']['VALUE'])
                            ? trim($arItem['PROPERTIES']['TYPEPRODUCT']['VALUE'])
                            : '';

                        $manufacturer = isset($arParams['MANUFACTURER'])
                        && !empty($arParams['MANUFACTURER'])
                            ? trim($arParams['MANUFACTURER'])
                            : (isset($arItem['PROPERTIES'])
                            && isset($arItem['PROPERTIES']['MANUFACTURER'])
                            && isset($arItem['PROPERTIES']['MANUFACTURER']['VALUE'])
                            && !empty($arItem['PROPERTIES']['MANUFACTURER']['VALUE'])
                                ? trim($arItem['PROPERTIES']['MANUFACTURER']['VALUE'])
                                : '');
                        ...
                        if(!empty($typeproduct)
                            ...
                            $arItem['NAME'] = $typeproduct;
                            $arItem['NAME'].= (!empty($arItem['NAME']) ? ' '.GetMessage('CATALOG_FOR').' ' : '') . $manufacturer;
                            $arItem['NAME'].= (!empty($arItem['NAME']) ? ' ' : ' '.GetMessage('CATALOG_FOR').' ') . $model_new;
                ...
                unset(
                    $arItem['PROPERTIES']['MANUFACTURER'],
                    $arItem['DISPLAY_PROPERTIES']['MANUFACTURER'],
                    $arItem['PROPERTIES']['TYPEPRODUCT'],
                    $arItem['DISPLAY_PROPERTIES']['TYPEPRODUCT'],
                    $arItem['DISPLAY_PROPERTIES']['QUALITY'],
                    $arItem['DISPLAY_PROPERTIES']['COM_BLACK'],
                    $arItem['DISPLAY_PROPERTIES']['NEWPRODUCT'],
                    $arItem['DISPLAY_PROPERTIES']['SALEPRODUCT'],
                    $arItem['PROPERTIES']['QUALITY'],
                    $arItem['PROPERTIES']['COM_BLACK'],
                    $arItem['PROPERTIES']['NEWPRODUCT'],
                    $arItem['PROPERTIES']['SALEPRODUCT']);

                ?>
                <input type="hidden" class="product_id" name="product_id[]" value="<?=$arItem['ID'];?>" />
                <?php if($key % $arParams['LINE_ELEMENT_COUNT'] == 0): ?>
                <?php endif; ?>
                <div class="col-xs-12 col-sm-<?=$elementClass;?> col-md-<?=$elementClass;?> col-lg-<?=$elementClass;?>">
                    <?
                    ...
                    ?>
                    <input type="hidden" class="product_cart_name" value="<?=$arItem['NAME'];?>" />
                        ...
                        <div class="bx_catalog_item_container" id="<? echo $strMainID; ?>">
                            ...
                            <div class="bx_catalog_item_images">
                                ...
                                <ul class="add-to-links add-to-links<? echo $strMainID; ?>">
                                    <li class="addtoCartElt addtoCartElt<?=$arItem['ID']; ?> addtoCartElt<? echo $strMainID; ?><? if (!$arItem['CAN_BUY']){ ?> hidden<? } ?>">
                                        <span class="ajax_add_to_cart_button ajax_add_to_cart_button<? echo $strMainID; ?>" id="<?=$arItemIDs['BUY_LINK_ICON'];?>">
                                        </span>
                                    </li>
                                    <li>
                                        <a class="lnk_view" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<?=$imgTitle; ?>">
                                        </a>
                                    </li>
                                </ul>
                            ...
                            if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
                            {
                                ...
                                <div class="bx_catalog_item_controls row">
                                    <?
                                    {
                                        ...
                                        {
                                            ?>
                                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 form-count-area<?=$arItem['ID'];?> form-count-area<? if (!$arItem['CAN_BUY']){ ?> hidden<? } ?>">
                                        ...
                                        ?>
                                        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 form-button-area<?=$arItem['ID'];?> form-button-area<? if (!$arItem['CAN_BUY']){ ?> hidden<? } ?>">
...

                                    {
                                        if(false){
                                            ...
                                            <div class="not-avail<?=$arItem['ID'];?> not-avail<? if ($arItem['CAN_BUY']){ ?> hidden<? } ?>">
                ...
                <?php if(((($key + 1) % $arParams['LINE_ELEMENT_COUNT']) == 0) || ((sizeof($arResult["ITEMS"]) - 1) == $key)): ?>
                <?php endif; ?>
                <?
            }
            ?>
