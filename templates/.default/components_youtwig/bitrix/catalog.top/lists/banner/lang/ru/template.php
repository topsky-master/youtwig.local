...
$MESS["CLEAN_FILTER"] = 'В результате фильтрации по Вашему запросу ничего не найдено. <a href="javascript:history.go(-1);">Измените фильтр, и попробуйте еще раз.</a>';
$MESS["CRL_QUANTITY"] = "На складе: ";
$MESS["COMMENT_TO_PRODUCT"] = "Комментарий к товару: ";
$MESS["CRL_QUALITY"] = "Качество: ";

$MESS["CT_BCS_TPL_ELEMENTS_NOT_FOUND"] = 'В результате фильтрации по Вашему запросу ничего не найдено. <a href="javascript:history.go(-1);">Измените фильтр, и попробуйте еще раз.</a>';
$MESS["CATALOG_FOR"] = " для ";

$MESS["TMPL_POSITION"] = "Номер позиции";
?>