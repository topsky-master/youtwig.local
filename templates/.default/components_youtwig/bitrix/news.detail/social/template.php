    ...
    <?php
		...
		?>
			...
			<li>
				...
				<a rel="nofollow" href="<?php echo $arResult["DISPLAY_PROPERTIES"]["SOCIAL_ICONS_LINKS"]["VALUE"][$key]; ?>"<?php if(!empty($tooltip)): ?> class="titles" data-original-title="<?php echo $tooltip; ?>"<?php endif;?>>
				<?php endif; ?>

					<?php if(isset($arResult["DISPLAY_PROPERTIES"]["SOCIAL_ICONS_FILES"]["VALUE"][$key])): ?>
						<i>
							<img src="<?php echo $arResult["DISPLAY_PROPERTIES"]["SOCIAL_ICONS_FILES"]["VALUE"][$key]; ?>" />
						</i>
					<?php else: ?>
