...
<div class="sort tabfilter">
    ...
    <a class="sortbutton active <?if($page == "active") echo " disabled current"?>" href="<?if($page != "active") echo $arResult["CURRENT_PAGE"]."?filter_history=N"; else echo "javascript:void(0)";?>"><?=GetMessage("STPOL_F_ACTIVE")?></a>
    <a class="sortbutton all<?if($page == "all") echo " disabled current"?>" href="<?if($page != "all") echo $arResult["CURRENT_PAGE"]."?filter_history=Y"; else echo "javascript:void(0)";?>"><?=GetMessage("STPOL_F_ALL")?></a>
    <a class="sortbutton completed<?if($page == "completed") echo " disabled current"?>" href="<?if($page != "completed") echo $arResult["CURRENT_PAGE"]."?filter_status=F&filter_history=Y"; else echo "javascript:void(0)";?>"><?=GetMessage("STPOL_F_COMPLETED")?></a>
    <a class="sortbutton canceled<?if($page == "canceled") echo " disabled current"?>" href="<?if($page != "canceled") echo $arResult["CURRENT_PAGE"]."?filter_canceled=Y&filter_history=Y"; else echo "javascript:void(0)";?>"><?=GetMessage("STPOL_F_CANCELED")?></a>
</div>
<?
$bNoOrder = true;
