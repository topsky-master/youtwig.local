...
if(isset($arResult["NAV_STRING"]) && !empty($arResult["NAV_STRING"])){
    ...
    if($arResult["NavPageNomer"] > 1){
        ...
        $pagenav_title = \COption::GetOptionString('my.stat', 'pagenav_brand_title', '', SITE_ID);
        ...
        $pagenav_description = \COption::GetOptionString('my.stat', 'pagenav_brand_description', '', SITE_ID);
    ...
    if(isset($arResult["sUrlPath"])
        ...
        if ($arResult["NavPageNomer"] > 1) {
            ...
            $canonicalURL = preg_replace('~/'.preg_quote('pages-','~').'[0-9]+?/~is','',$link_prev);
