...
if(is_array($arResult["ITEMS"])
    ...
    ?>
    <div class="hidden-lg hidden-md hidden-sm main-icons main-icons-mobile">
            ...
            <div class="row clearfix">
                <?foreach($arResult["ITEMS"] as $arItem):?>
                    ...
                    &&isset($arItem['DISPLAY_PROPERTIES']['LINK']['VALUE'])
                        ...
                        : '';
                    ?>
                    <div class="small-pading col-sm-4 col-xs-4 col-md-4 col-lg-4" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                        <div class="element">
                            <?if(!empty($smLink)):?>
                            <a href="<?=$smLink;?>">
                                <?endif;?>
