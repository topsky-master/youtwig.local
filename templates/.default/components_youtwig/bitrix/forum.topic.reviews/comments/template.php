        ...
        <div class="reviews-block-outer">
            <div class="reviews-block-inner">
                ...
                foreach ($arResult["MESSAGES"] as $res):
                    $iCount++;
                    ?><table itemprop="review" itemscope itemtype="http://schema.org/Review" cellspacing="0" border="0" class="reviews-post-table <?=($iCount == 1 ? "reviews-post-first " : "")?><?
                ...
                ?>" bx-author-id="<?=$res["AUTHOR_ID"]?>" bx-author-name="<?=$res["AUTHOR_NAME"]?>" id="message<?=$res["ID"]?>">
                    <thead><tr><td>
                            ...
                            <div class="container-fluid">
                                <div class="col-xs-12 col-sm-6 mess-author-info">
                                    <?
                                    ...
                                    if ($arParams["SHOW_RATING"] == "Y")
                                    {
                                        ...
                                        <div class="review-rating rating_vote_graphic">
                                            ...
                                            $arRatingParams = Array(
                                                ...
                                                "PATH_TO_USER_PROFILE" => mb_strlen($arParams["PATH_TO_USER"]) > 0? $arParams["PATH_TO_USER"]: $arParams["~URL_TEMPLATES_PROFILE_VIEW"]
                                            );
                                            if (!isset($res['RATING']))
                                                $res['RATING'] = array(
                                                    "USER_VOTE" => 0,
                                    ...
                                    <div>
                                        <b><?
                                            ...
                                            ?></b>
                                        <time class="message-post-date" itemprop="datePublished" datetime="<?=date('Y-m-d',strtotime($res["POST_DATE"]));?>"><?=$res["POST_DATE"]?></time>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 mess-rating-info text-right">
                                    <?php
                    ...
                    <tbody>
                    <tr><td>
                            <div class="reviews-text" itemprop="description" id="message_text_<?=$res["ID"]?>"><?=$res["POST_MESSAGE_TEXT"]?></div>
                            <?
