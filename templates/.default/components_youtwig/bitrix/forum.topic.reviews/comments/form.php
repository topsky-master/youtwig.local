        ...
        ?> method="POST" enctype="multipart/form-data" class="reviews-form">
            ...
            <div style="position:relative; display: block; width:100%;">
                ...
                if (!$arResult["IS_AUTHORIZED"]):
                    ?>
                    <div class="reviews-reply-fields container-fluid reviews-reply">
                        <div class="reviews-reply-field-user col-sm-6 col-xs-12 ">
                        ...
                        <div class="col-sm-6 col-xs-12 reviews-reply-rating text-right">
                            <?php for ($starCount = 1; $starCount < $maxStars; $starCount ++): ?>
                                <label class="fa star fa-star-o">
                                    <input type="radio" name="vote" value="<?=$starCount;?>" />
                                </label>
                            <?php endfor; ?>
                        </div>
                        <script type="text/javascript">
                            //<!--
                            $('.reviews-reply-rating .star').click(function(){
                                $('.reviews-reply-rating .star').removeClass('fa-star').addClass('fa-star-o');
                                $(this).prevAll('.star').removeClass('fa-star-o').addClass('fa-star');
                ...
                ?>
                <div<?php if ($arResult["IS_AUTHORIZED"]): ?> class="container-fluid reviews-reply"<?php endif; ?>>
                    <div class="<?php if ($arResult["IS_AUTHORIZED"]): ?>col-sm-6 col-xs-12<?php endif; ?> reviews-reply-header"><span><?=$arParams["MESSAGE_TITLE"]?></span><span class="reviews-required-field">*</span></div>
                ...
                if (mb_strlen($arResult["CAPTCHA_CODE"]) > 0):
                    ...
                    \Bitrix\Main\Page\Frame::getInstance()->startDynamicWithID("commentform");
                    ...
                    \Bitrix\Main\Page\Frame::getInstance()->finishDynamicWithID("commentform", "");
                ...
                <div class="reviews-reply-buttons">
                    ...
                    <input class="btn btn-info" name="view_button" type="submit" value="<?=GetMessage("OPINIONS_PREVIEW")?>" tabindex="<?=$tabIndex++;?>" <?
