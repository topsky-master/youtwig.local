...
if (is_object($this->__component))
{
	...
	$this->__component->SetResultCacheKeys(array('COUNT_ITEMS','NavPageCount'));

	if (!isset($arResult['NavPageCount']))
        $arResult['NavPageCount'] = $this->__component->arResult['NavPageCount'];
