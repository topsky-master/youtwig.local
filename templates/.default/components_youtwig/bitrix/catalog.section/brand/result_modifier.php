...
if (!empty($arResult['ITEMS']))
{
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
        ...
        &&!checkQuantityRigths()){
            unset($arItem['DISPLAY_PROPERTIES']['COM_BLACK']);
        }

        if(isset($arItem['DISPLAY_PROPERTIES'])
            &&isset($arItem['DISPLAY_PROPERTIES']['QUALITY'])
            &&isset($arItem['DISPLAY_PROPERTIES']['QUALITY']['VALUE'])
            &&!empty($arItem['DISPLAY_PROPERTIES']['QUALITY']['VALUE'])
            &&!checkQuantityRigths()){
            unset($arItem['DISPLAY_PROPERTIES']['QUALITY']);
        }
...
{
    $this->__component->SetResultCacheKeys(array('ITEMS','NAV_STRING'));
