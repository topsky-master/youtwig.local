...
<div class="ordercart">
    ...
    <p class="h4 h4-order-title"><?=GetMessage("SALE_PRODUCTS_SUMMARY");?></p>
    <a class="h4 h4-share" data-toggle="modal" data-target="#sharemodal" title="Поделиться корзиной">Поделиться корзиной</a>
    </div>
    <div>
