...
$arTemplateParameters['DISPLAY_CODES_VERTICAL'] = array(
    'PARENT' => 'FILTER_SETTINGS',
    'NAME' => GetMessage('CPT_LIST_DISPLAY_CODES_VERTICAL'),
    'TYPE' => 'STRING',
);

$arTemplateParameters['DISPLAY_CODES_HORIZONTAL'] = array(
    'PARENT' => 'FILTER_SETTINGS',
    'NAME' => GetMessage('CPT_LIST_DISPLAY_CODES_HORIZONTAL'),
    'TYPE' => 'STRING',
);
...
$arTemplateParameters["ELEMENTS_COLLAPSE"] = array(
    "PARENT" => "FILTER_SETTINGS",
    "NAME" => GetMessage("CPT_BC_ELEMENTS_COLLAPSE"),
    "TYPE" => "STRING",
    "DEFAULT" => "",
);
...
$arTopViewModeList = array(
    'LIST' => GetMessage('CPT_BC_TPL_VIEW_LIST'),
    'GRID' => GetMessage('CPT_BC_TPL_VIEW_GRID')
);

$arTemplateParameters['LIST_TYPE'] = array(
    'PARENT' => 'LIST_SETTINGS',
    'NAME' => GetMessage('CPT_LIST_TYPE'),
    'TYPE' => 'LIST',
    'VALUES' => $arTopViewModeList,
    'MULTIPLE' => 'N',
    'DEFAULT' => 'GRID'
...
$arTemplateParameters['NOT_MUCH'] = array(
    'NAME' => GetMessage('CPT_NOT_MUCH'),
);

$arTemplateParameters['SET_SECTION_ID'] = array(
    'NAME' => GetMessage('CPT_SET_SECTION_ID'),
);
