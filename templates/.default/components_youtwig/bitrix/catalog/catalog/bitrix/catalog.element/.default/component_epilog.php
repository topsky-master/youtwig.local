...
?>
    <div role="tabpanel" id="comments" class="tab-pane comments elements clearfix">
        <?
    ...
    <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
        <div class="hidden-xs">
            <div id="viewed" class="viewed clearfix">
                <h3>
                    <?php  echo GetMessage("VIEWED_PRODUCTS_TITLE");?>
                </h3>
                <div class="viewed wrapper clearfix" id="viewed_wrapper">
                </div>
            </div>
            <div id="banner-view" class="banner-view clearfix">
                <a href="http://clck.yandex.ru/redir/dtype=stred/pid=47/cid=2508/*http://market.yandex.ru/shop/228852/reviews">
                    <img src="<?=$templateFolder;?>/images/vote-yandex.jpg" class="img-responsive" width="100%" height="auto" alt="Отзывы о магазине TWiG" />
                </a>
            </div>
        </div>
    </div>
