...
abstract class AMP_Base_Sanitizer {
	 ...
	 * See https://github.com/Automattic/amp/issues/101
	 */
	public function enforce_sizes_attribute( $attributes ) {
		...
		$attributes['sizes'] = sprintf( '(min-width: %1$dpx) %1$dpx, 100vw', abs( (int) $max_width ) );

		$this->add_or_append_attribute( $attributes, 'class', 'amp-enforced-sizes' );
