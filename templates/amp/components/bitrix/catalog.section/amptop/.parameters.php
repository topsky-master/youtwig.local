...
$arTemplateParameters['IS_MODEL_LIST'] = array(
    'NAME' => GetMessage('CP_BCS_TPL_IS_MODEL_LIST'),
    'TYPE' => 'CHECKBOX',
    'REFRESH' => 'Y',
    'DEFAULT' => 'N'
);

$arTemplateParameters['CANONICAL_URL'] = array(
    'NAME' => GetMessage('CP_BCS_TPL_CANONICAL_URL'),
    'TYPE' => 'STRING',
);

$arTemplateParameters['BLOCK_TITLE'] = array(
    'NAME' => GetMessage('CP_BCS_TPL_BLOCK_TITLE'),
    'TYPE' => 'STRING',
);
