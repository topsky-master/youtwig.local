...
class CSaleFormatProperties{
    ...
    public static function printDeliveryProviderCode($chained = array(), $number) {
        ...
        file_put_contents(__DIR__.'/info.log', 'poviderCodeKey123 = \n');
        file_put_contents(__DIR__.'/info.log', var_export($poviderCodeKey, true), FILE_APPEND);
        file_put_contents(__DIR__.'/info.log', 'arProperties = \n', FILE_APPEND);
        file_put_contents(__DIR__.'/info.log', var_export($arProperties, true), FILE_APPEND);
        file_put_contents(__DIR__.'/info.log', 'codeProperty = \n', FILE_APPEND);
        file_put_contents(__DIR__.'/info.log', var_export($codeProperty, true), FILE_APPEND);
    ...
    public static function getCSaleProperties($chained = array(), $number){
        ...
        $poviderCodeKey = "145"; // apiship delivery provider code
        $propsSortedByGroup = array();
        $propsSortedByGroup = self::getOrderProperties();
