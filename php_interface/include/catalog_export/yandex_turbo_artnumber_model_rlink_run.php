<?php
//<title>Yandex turbo pages model TWG000 (без ссылки)</title>

ini_set('default_charset', 'utf-8');
global $protocol, $product_image_width, $product_image_height;

$append = 'Внимательно проверяйте модель вашего устройства со списком моделей в описании, в противном случае товар не подойдет. ';
    ...
    while ($obElement = $res->GetNextElement()) {
        ...
        foreach ($apItems as $arAcc) {
            ...
            if (($quantity_product = get_quantity_product($arAcc['ID'], false, ($arStores = array(3, 6, 9, 10)))) > 0) {
                ...
                $DETAIL_TEXT = $append.$DETAIL_TEXT;
