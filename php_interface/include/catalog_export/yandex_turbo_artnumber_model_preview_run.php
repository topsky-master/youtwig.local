<?php
//<title>Yandex turbo pages model TWG000 preview text</title>
...
if (isset($aDisableProfiles[$PROFILE_ID]) && !empty($aDisableProfiles[$PROFILE_ID])) {
                ...
                foreach ($arYandexFields as $key) {
                    switch ($key) {
                        ...
                        case 'description':
                            ...
                            $DETAIL_TEXT = $arAcc["PREVIEW_TEXT"];
                            ...
                            if (false && !(isset($arAcc["PROPERTY_HIDE_MODELS_VALUE"])
