    ...
    if(
        ...
        if (!empty($chained)) {
            ...
            && sizeof($deliveryIds) > 1
                ...
                : $deliveryIds;
    file_put_contents(__DIR__.'/info.log','propertyCollection = ');
    file_put_contents(__DIR__.'/info.log',var_export($propertyCollection,true), FILE_APPEND);

file_put_contents(__DIR__.'/info.log','paymentIds = ', FILE_APPEND);
file_put_contents(__DIR__.'/info.log',var_export($paymentIds,true), FILE_APPEND);

file_put_contents(__DIR__.'/info.log','deliveryIds = ', FILE_APPEND);
file_put_contents(__DIR__.'/info.log',var_export($deliveryIds,true), FILE_APPEND);


file_put_contents(__DIR__.'/info.log','deliveries = ', FILE_APPEND);
file_put_contents(__DIR__.'/info.log',var_export($chained['deliveries'],true), FILE_APPEND);


file_put_contents(__DIR__.'/info.log','payments = ', FILE_APPEND);
file_put_contents(__DIR__.'/info.log',var_export($chained['payments'],true), FILE_APPEND);
...
file_put_contents(__DIR__.'/info.log','number = ', FILE_APPEND);
file_put_contents(__DIR__.'/info.log',var_export($number,true), FILE_APPEND);

file_put_contents(__DIR__.'/info.log','paymentID = ', FILE_APPEND);
file_put_contents(__DIR__.'/info.log',var_export($paymentID,true), FILE_APPEND);
    ...
    file_put_contents(__DIR__.'/info.log','chained[prop] =', FILE_APPEND);
    file_put_contents(__DIR__.'/info.log',var_export($chained['prop'],true), FILE_APPEND);
                                                            
                            $providerCodeKey = 143; // shipping provider code
                            if(isSet($chained['prop'][145])) {
    ...
    file_put_contents(__DIR__.'/info.log','providerPropValue[$number] = ', FILE_APPEND);
    file_put_contents(__DIR__.'/info.log',var_export($providerPropValue[$number],true), FILE_APPEND);
                                ...
                                if($currentProp && $providerCode != "" && $providerPropValue[$number] != "" && $providerCode != $providerPropValue[$number]) {
                                    ...
                                    continue; // don't need to set the fields
                                } else {
