<?
	...
	*/
	...
	if($_REQUEST['action'] == 'sitemap_run') // && check_bitrix_sessid()
	{
		...
		//SitemapRuntime::showProgress($msg, Loc::getMessage('SEO_SITEMAP_RUN_TITLE'), $v);
	...
	file_put_contents($_SERVER['DOCUMENT_ROOT'].'bitrix/tmp/sitemap_generate.txt',var_export($arPrint,true));
