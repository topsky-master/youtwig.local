...

{
    ...
    {
        if(is_array($arSelectFields) && (in_array("DETAIL_PAGE_URL", $arSelectFields) || in_array("CANONICAL_PAGE_URL", $arSelectFields))
    ...
    // var_dump("local.changes.bitrix.modules.iblock.clsses.general.iblockelement::preparelist => ", "start");
    // exit(0);
        ...
        // For Debug
		// if(is_set($arFilter["PROPERTY_DOMAIN_VALUE"]) && is_set($arFilter["CODE"]) && $arFilter["CODE"] == "logotype") {
		// 	echo '<pre>';
		// 	var_dump("local.changes.bitrix.modules.iblock.clsses.general.iblockelement::preparelist => arJoinProps", $arJoinProps);
		// 	echo '</pre>';
		// 	exit(0);
		// }
