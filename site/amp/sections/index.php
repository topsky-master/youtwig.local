...
?><?$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "DISPLAY_CODES" => "TYPEPRODUCT,MANUFACTURER",
        "DISPLAY_TOP_PAGER" => "Y",
        ...
        "FILTER_PROPERTY_CODE" => array("TYPEPRODUCT","MANUFACTURER",""),
        ...
        "SEF_FOLDER" => "/amp/",
        "SEF_MODE" => "Y",
        "SEF_URL_TEMPLATES" => Array("compare"=>"","element"=>"catalog/#ELEMENT_CODE#/","section"=>"sections/#SECTION_CODE#/","sections"=>"sections/","smart_filter"=>"sections/#SECTION_CODE#/filter/#SMART_FILTER_PATH#/"),
        "SET_LAST_MODIFIED" => "N",
        "SET_STATUS_404" => "Y",
        "SET_TITLE" => "Y",
        "SHOW_404" => "N",
        ...
        "TOP_ELEMENT_COUNT" => "9",
        "TOP_ELEMENT_SORT_FIELD" => "propertysort_ONSTOCK",
